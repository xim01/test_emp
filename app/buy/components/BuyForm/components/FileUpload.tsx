  ...
  return (
    <div className={styles.fileRow}>
      <label htmlFor="fileUpload" className={styles.fileLabel}>
        <div className={styles.fileLabelIcon}>{fileSvg}</div>
        ПРИКРЕПИТЬ ФАЙЛ
      </label>
